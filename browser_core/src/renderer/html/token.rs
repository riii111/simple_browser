...
mod tests {
    ...
    fn test_self_closing_tag() {
        /* コンテンツを何ももたない空要素の場合、self_closingフラグがtrueであることを確認する */
    ...
    #[test]
    fn test_script_tag() {
        /* <script>タグで囲まれたコンテンツが認識されることを確認する */
